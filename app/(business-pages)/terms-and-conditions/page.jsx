    ...
    <div className="py-6">
      <div className="px-6">
        ...
        <div className="pt-6 pb-[4rem]">
          ...
          <p className="mb-4">
            Welcome to Sayyam Jain&apos;s Portfolio. By accessing or using this
          ...
          <ol className="list-decimal list-inside list-wrapper">
            ...
            <li>
              ...
              <div>
                <p>
                  ...
                  Sayyam Jain, including custom web and software development.
            ...
            <li>
              ...
              <div>
                <p>
                  ...
                  intellectual property of Sayyam Jain unless stated otherwise.
            ...
            <li>
              ...
              <div>
                <p>
                  Sayyam Jain is not liable for any direct, indirect, or
            ...
            <li>
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                  <span>
                    <a href="mailto:sayyamjain535@gmail.com">
                      Email - sayyamjain535@gmail.com
                    </a>
                  </span>
                  <span>
                    <a href="tel:+919422115276">Phone - +91 9422115276</a>
                  </span>
