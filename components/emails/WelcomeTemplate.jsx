...
export const YelpRecentLoginEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Sayyam Jain Portfolio</Preview>
      <Body style={main}>
        <Container>
          <Section style={content}>
            <Row style={{ ...boxInfos, paddingBottom: "0" }}>
              <Column>
                ...
                >
                  Hi {u_user === "admin" ? "Sayyam" : u_name.split(" ")[0]},
                </Heading>
                <Heading
                  as="h2"
                  style={{
            ...
            <Row style={{ ...boxInfos, paddingTop: "0" }}>
              <Column style={containerButton} colSpan={2}>
                {u_user === "admin" ? (
                  ...
                  <Button href={`mailto:sayyamjain535@gmail.com`} style={button}>
                    Mail Admin
                  </Button>
                )}
              </Column>
          ...
          >
            © {new Date().getFullYear()} | Sayyam Jain | Portfolio
          </Text>
        </Container>
      </Body>
    </Html>
