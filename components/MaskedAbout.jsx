          ...
          <div ref={stickyMask} className="stickyMask relative">
            ...
            >
              ...
              <p ref={paragraph3} className="w-full text-lg md:text-xl lg:text-2xl font-roboto">
                When I&quot;m not coding, you&quot;ll often find me in the <span className="font-orisis">gym</span> or <span className="font-orisis">exploring creative ideas</span> that blend technology
                with everyday life.
              </p>
              ...
              <p ref={paragraph5} className="w-full text-xl md:text-2xl lg:text-3xl">
                Reach me at: <a href="mailto:contact@sayyamjain535@gmail.com" target="_blank">sayyamjain535@gmail.com</a>
              </p>
            </div>
          </div>
        </div>
